...
public class AdventureProcessMethodMockTest {
	...
	@Test
	public void exceptionBank(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations(){{
			BankInterface.processPayment(IBAN, 300);
	...
	@Test
	public void exceptionHotel(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations(){{
			BankInterface.processPayment(IBAN, 300);
	...
	@Test
	public void exceptionActivity(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations(){{
			BankInterface.processPayment(IBAN, 300);
			result = PAYMENT_CONFIRMATION;
			HotelInterface.reserveHotel(Type.SINGLE, begin, end);
			result = HOTEL_REFERENCE;
